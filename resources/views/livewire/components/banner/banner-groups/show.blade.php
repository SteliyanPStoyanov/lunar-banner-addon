        ...
        <div class="flex items-center justify-between">
            <div class="w-full">
                <input id="group-name" wire:model.lazy="group.name"
                    @class([ 'w-full px-3 py-2 bg-transparent border border-dashed border-gray-300 rounded',
        ...
        <div class="mt-4">
            <x-hub::modal.dialog wire:model="showDeleteConfirm" form="deleteGroup">
                ...
                <x-slot name="footer">
                    ...
                    <x-hub::button type="submit" theme="danger" :disabled="!$deletionConfirm">
                        {{ __('banner::catalogue.banners.groups.delete.btn') }}
                    </x-hub::button>
                </x-slot>
            </x-hub::modal.dialog>
            <x-hub::modal.dialog wire:model="showCreateForm" form="createBanner">
                <x-slot name="title">
