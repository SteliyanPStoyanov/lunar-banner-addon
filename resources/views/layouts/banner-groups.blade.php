...
@section('menu')
    <x-hub::layout.side-menu>
        @livewire('components.banner.side-menu', [ 'currentGroup' => $group ?? null, ])
    </x-hub::layout.side-menu>
@stop
@section('main')
    <div class="space-y-6">
        <div x-data="{ showGroupSlideOver: false }">
            <div class="flex items-center justify-between">
                ...
                <div class="block lg:hidden">
                    <x-hub::button type="button" theme="gray" x-on:click="showGroupSlideOver = !showGroupSlideOver">
                        {{ __('banner::button.view-banner-groups') }}
                    </x-hub::button>
                </div>
            </div>
